...
//teacher specfic 
educatorRouter.post("/teacher/add", isAdminAuthenticated, async (req: Request, res: Response, next: NextFunction) => {
  const user = req.user as User;
...
educatorRouter.delete("/teacher/delete/:teacherId", isAdminAuthenticated, async (req: Request, res: Response, next: NextFunction) => {
...
educatorRouter.get("/teacher/list", isAdminAuthenticated, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const services = getServices();
