<template>
  <b-container fluid class="h-100 w-100 m-0 p-0 d-flex flex-column">
      ...
      <b-row class="h-100 m-0">
        <b-col class="mh-100 p-2">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              <b-button variant="success" class="mr-2" @click="showAddTeacherModal">Add Teacher</b-button>
            </div>
          </div>
          ...
          <div class="h-100-header w-100 content-container">
            ...
            >
              ...
              <template #cell(actions)="data">
                <b-button variant="primary" @click="confirmDeleteTeacher(data.item)">Delete</b-button>
              </template>
            </b-table>
          </div>
        </b-col>
    ...
    >
      <span>Your password is: <b>{{ newTeacherPassword }}</b></span>
      <br />
